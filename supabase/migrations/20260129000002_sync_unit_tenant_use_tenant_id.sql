-- Update sync function: add optional p_tenant_id so we can sync by selected tenant id (most reliable).
-- Drop old 2-arg version and create new 3-arg version.

DROP FUNCTION IF EXISTS public.sync_unit_tenant_to_profile_by_email(UUID, TEXT);
